...
# define YOLO1 "current(%zd) next(%zd) die(%zd) check(%d) live(%zu)\n"
# define CHECK_TEMPLATE CHECK_PREFIX YOLO1
...
# define YOLO2 "setup server interface %s:%d (%x) (%x)\n"
# define SOCKET_INTERFACE SOCKET_SETUP_PREFIX YOLO2
...
# define YOLO3 "waiting for new connexion, timeout in (%u sec) (%u usec)\n"
# define SOCKET_WAITING SOCKET_CO_PREFIX YOLO3
