...
/*   Updated: 2019/05/03 14:37:05 by fbenneto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const t_op g_op[17] = {
	...
	{"ldi", 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, 0xa, 25,
		"load index", 1, 1},

	{"sti", 3, {T_REG, T_REG | T_DIR | T_IND, T_DIR | T_REG}, 0xb, 25,
		"store index", 1, 1},
	...
	{"lldi", 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, 0xe, 50,
		"long load index", 1, 1},
