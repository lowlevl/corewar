...
/*   Updated: 2019/03/08 12:01:50 by glodi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_processes(t_player *players, uint8_t count)
{
	...
	while  (i < count)
	{
		...
		player->processes[1] = (t_process){ .player_id = player->default_id,
...
void add_processes(t_player *player, uint16_t pc)
{
	...
	player->processes[n] = (t_process){ .player_id = player->default_id,
